...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/yerrakaushik",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@kaushik",
    icon: Instagram,
    url: "https://www.instagram.com/kaushik.yerra",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Kaushik",
    icon: Github,
    url: "https://github.com/kaushikyerra",
    color: "#333333",
  ...
  return (
    <div className="w-full">
      <h3 className="text-lg font-semibold mb-4 flex items-center gap-2" style={{ color: "var(--text-primary)" }}>
        <span className="inline-block w-6 h-1 rounded-full" style={{ backgroundColor: "var(--primary)" }}></span>
        Connect With Me
      </h3>
      ...
      <div className="flex flex-col gap-3">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-xl border transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 bg-gray-50"
          style={{ borderColor: "var(--border-color)" }}
        >
          <div className="relative flex items-center gap-4">
            <div className="relative flex items-center justify-center">
              <div 
                className="absolute inset-0 rounded-lg transition-all duration-300 group-hover:scale-110"
                style={{ backgroundColor: linkedIn.bg }}
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[instagram, youtube].map((link) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center gap-3 p-3 rounded-xl border transition-all duration-300 hover:shadow-sm hover:-translate-y-0.5 bg-gray-50"
              style={{ borderColor: "var(--border-color)" }}
            >
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-0 rounded-lg transition-all duration-300 group-hover:scale-110"
              ...
              <ExternalLink className="w-4 h-4 ml-auto opacity-0 group-hover:opacity-100 transition-all duration-300 transform -translate-x-2 group-hover:translate-x-0" style={{ color: "var(--primary)" }} />
            </a>
          ))}
        </div>
